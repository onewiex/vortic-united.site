...
export const Privacy = () => {
    ...
    <div class="container">
      <div class="CmsCntSec">
        <div class="CmsHdd">
          <h4>Privacy Policy for Vortic United</h4>
        </div>
        <div class="CmsItm mb-5">
          <div class="CmsCnt">
            <p>At Vortic United, accessible from coinfinity-group.net, one of our main priorities is the
              privacy of our visitors. This Privacy Policy document contains types of information that
              is collected and recorded by Vortic United and how we use it. If you have additional
              questions or require more information about our Privacy Policy, do not hesitate to
              contact us.</p>
          </div>
        </div>
        <div class="CmsItm mb-3">
          <div class="CmsSbHdd">
            <h4>Log Files</h4>
          </div>
          <div class="CmsCnt">
            <p>Vortic United follows a standard procedure of using log files. These files log visitors
        ...
        <div class="CmsItm mb-3">
          ...
          <div class="CmsCnt">
            <p>Like any other website, Vortic United uses 'cookies'. These cookies are used to store
        ...
        <div class="CmsItm mb-3">
          ...
          <div class="CmsCnt">
            ...
            following URL – https://policies.google.com/technologies/ads.</p>
          </div>
        </div>
        <div class="CmsItm mb-3">
          <div class="CmsSbHdd">
        ...
        <div class="CmsItm mb-3">
          ...
          <div class="CmsCnt">
            ...
            of Vortic United. Our Privacy Policy was created with the help of the Privacy Policy
            Generator and the Generate Privacy Policy Generator.</p>
            <div class="CmsCnt">
                ...
                on Vortic United, which are sent directly to users' browser. They automatically receive
                your IP address when this occurs. These technologies are used to measure theeffectiveness of their advertising campaigns and/or to personalize the advertising
                content that you see on websites that you visit.
                Note that Vortic United has no access to or control over these cookies that are used by
        ...
        <div class="CmsItm mb-3">
          ...
          <div class="CmsCnt">
            <p>Vortic United's Privacy Policy does not apply to other advertisers or websites. Thus, we
            ...
            <div class="CmsCnt">
                ...
                can be found at the browsers' respective websites. What Are Cookies?</p>
            </div>
          </div>
        </div>
        <div class="CmsItm mb-3">
          ...
          <div class="CmsCnt">
            ...
            <div class="CmsCnt">
                <p>Vortic United does not knowingly collect any Personal Identifiable Information from
        ...
        <div class="CmsItm mb-3">
          ...
          <div class="CmsCnt">
            ...
            website with regards to the information that they shared and/or collect in Vortic
            United. This policy is not applicable to any information collected offline or via channels
